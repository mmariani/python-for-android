...
function prebuild_python() {
	...
	try patch -p1 < $RECIPE_python/patches/fix-grp-import.patch
...
function build_python() {
	...
	try ./configure --host=$CONFIGURE_HOST OPT=$OFLAG --prefix="$BUILD_PATH/python-install" --enable-shared --disable-toolbox-glue --disable-framework
	echo ./configure --host=$CONFIGURE_HOST  OPT=$OFLAG --prefix="$BUILD_PATH/python-install" --enable-shared --disable-toolbox-glue --disable-framework
